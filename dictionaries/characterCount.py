import pprint # to use the pprint function which stands for "pretty print"
...
count = {} # character will be stored at key and its occurance count will be stored at value

for character in message.upper():
    count.setdefault(character, 0)  # set first character as key if it doesn;t exists and set the value to 0 by default
    count[character] = count[character] + 1 # get the value at the key and update the value

pprint.pprint(count) # pretty printing

rjText = pprint.pformat(count)  # Format a Python object into a pretty-printed representation.
print(rjText)